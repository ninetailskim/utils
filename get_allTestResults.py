...
MEPOCH = "66431"
PATH_TO_TEST_IMAGES = "G:/workspace/detection_project/test_images"
MODEL_NAME = 'G:/workspace/detection_project/exported_result' + MEPOCH
PATH_TO_CKPT = MODEL_NAME + '\\frozen_inference_graph.pb'
PATH_TO_LABELS = 'G:/workspace/detection_project/data/label_map.pbtxt'
NUM_CLASSES = 5
PATH_TO_RESULTS = "G:/workspace/detection_project/results" + MEPOCH
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph) as sess:
            ...
            for test_image in os.listdir(PATH_TO_TEST_IMAGES):
                ...
                print(str(myin) +'  ' + test_image + ' succeed')
                myin = myin + 1
